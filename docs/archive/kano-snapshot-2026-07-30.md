# Архивный KANO snapshot Easy Peasy DLS

> Заморожено 30 июля 2026 года. Этот исторический planning snapshot не является
> текущим runtime contract и не участвует в validators.
