...
В новой задаче выберите навык **Easy Peasy DLS: процесс**. Для изменения или
новой функции напишите:
...
исходный JSON, точную ошибку и допустимые ID. Product source, native output и
другие review-драфты в этот вызов не передаются.
